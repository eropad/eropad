...
class Gpt3ApI {
	...
	async generateBlog() {
		...
		12. Experiment and push boundaries exploring taboos and non-consensual themes (example: BDSM, Horror, Transgressive, Interracial, Hentai, Fantasy, Paranormal, Incest, Polygamy, Orgy, Celebrity)
